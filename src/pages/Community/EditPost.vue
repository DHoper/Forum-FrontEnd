...
import { updatePost, getPostData } from "../../api/community/community.js";
import {
  CommunityPostType,
  PhotoPostImageType,
} from "../../types.js";
        ...
        <div class="mt-12 border-2 border-stone-800 px-24 py-16">
          ...
          <form class="mt-4 flex flex-col gap-4 2xl:gap-12">
            <div class="relative">
              <label
                for="title"
                class="text-stone-600 font-bold text-sm 2xl:text-lg"
                >標題</label
              >
              <input
                ...
                :class="
                  formInputInvalid.title ? 'border-stone-800' : 'border-red-700'
                "
                required
              />
              <div
            ...
            <div>
              <label class="text-stone-600 font-bold text-sm 2xl:text-lg"
                >貼文主題(最多五項)</label
              >
              <div
                class="mt-4 border-2 border-stone-700 p-2 overflow-auto max-h-48"
              >
                <div
                  ...
                  <div class="mt-4 flex flex-wrap gap-2 justify-center">
                    ...
                    >
                      <input
                        ...
                        class="hidden"
                        :disabled="
                          isMaxSelected && !formData.topicTags.includes(tag)
                        "
                      />
