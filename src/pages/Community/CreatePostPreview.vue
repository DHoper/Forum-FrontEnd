...
<template>
  ...
  >
    <div
      class="mt-12 mx-auto border-2 border-stone-800 w-[62rem] max-w-full px-24 py-16"
    >
      ...
      <div class="flex gap-2 flex-wrap">
        <span
          v-for="tag in formData.topicTags"
      ...
      <div class="flex justify-between">
        ...
        >
          <HeartIcon
            class="w-4 2xl:w-6 group-focus:scale-[125%] transition-all duration-300"
          />0
        </span>
      </div>
    </div>
    <div class="flex gap-16 text-xl">
      <button
        ...
        :class="isSubmitting? 'bg-stone-400':'bg-green-600 hover:border-green-600 hover:bg-white hover:text-green-600 transition-all duration-300'"
      >
        發佈
      </button>
      <button
