...
import { CommunityPostType, DialogType, PhotoPostType } from "../../types";
import {
...
<template>
  <div class="flex-1 bg-stone-100 py-24">
    <div
      v-if="photoPosts && communityPosts"
    ...
    >
      ...
      <!-- 照片牆 -->
      <div
        v-if="activeTab === 'photoPosts' && visiblePhotoPosts"
        class="w-full mt-10"
        :class="visiblePhotoPosts.length > 0 ? 'h-[45rem]' : ''"
      >
        <div
          v-if="visiblePhotoPosts.length > 0"
        ...
        >
          <div class="flex justify-between">
            ...
            <div class="flex gap-4">
              <EyeIcon
                @click="openPostInNewTab(ActionPageType.PhotoPost, post._id!)"
              ...
              />
              <TrashIcon
                @click="handleDelete(ActionPageType.PhotoPost, post._id!)"
      ...
      <!-- 社區 -->
      <div
        v-if="activeTab === 'communityPosts' && visibleCommunityPosts"
        class="w-full mt-10"
        :class="visibleCommunityPosts.length > 0 ? 'h-[45rem]' : ''"
      >
        <div
          v-if="visibleCommunityPosts.length > 0"
        ...
        >
          <div class="flex justify-between">
            ...
            <div class="flex gap-4">
              ...
              />
              <TrashIcon
                @click="handleDelete(ActionPageType.CommunityPost, post._id!)"
                class="w-6 cursor-pointer text-red-700 hover:text-red-500 transition-all duration-300"
              />
            </div>
          </div>
