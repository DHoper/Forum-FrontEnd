...
import { getUserData } from "../../api/user/user.js";
...
const fetchUserData = async () => {
  if (props.email === "self") {
    ...
    const responseData = await getUserData(props.email);
  ...
  >
    ...
    >
      <div class="flex flex-col items-center gap-4">
        <div
          class="flex justify-center border-2 border-stone-700 p-2 rounded-full w-36 h-36 overflow-hidden"
        >
          <img
      ...
      <div class="w-full flex flex-col items-center gap-4">
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="relative">
              <input
                ...
                class="text-lg border-2 p-2"
                :class="
                  formInputInvalid.passwordConfirm
                    ? 'border-stone-600'
                    : 'border-red-600'
                "
              />
        ...
        <div class="w-full flex flex-col items-center gap-3 flex-1">
          ...
          <div
            class="w-full overflow-auto max-h-40 min flex items-center justify-center flex-wrap border-2 border-stone-600 p-2 gap-2"
          >
            <div
              v-if="!isEditing"
    ...
    >
      ...
      >
        ...
        >
          <p class="block text-stone-700 text-xl font-bold tracking-widest">
            選擇頭像
          </p>
