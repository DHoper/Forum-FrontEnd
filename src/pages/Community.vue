...
<template>
  <div
    v-if="communityPosts && votes && usernameList"
  ...
  >
      ...
      <div class="flex gap-8 overflow-auto">
        ...
        >
          ...
          <div class="mt-4 flex justify-between items-center">
            ...
            <button
              class="bg-stone-800 text-white px-3 py-1 hover:bg-stone-800"
            >
              投票
            </button>
          </div>
    ...
    <div class="w-full mt-auto">
      ...
      <div class="flex flex-col gap-4 justify-between mt-8">
        <div
          v-for="(communityPost, index) in filteredPosts"
          :key="communityPost._id"
          @click="
            router.push({
              name: 'CommunityPost',
        ...
        >
          <div class="flex justify-between">
            <div class="flex gap-4 items-center justify-center">
              ...
              <div class="flex gap-2 flex-wrap">
                <span
                  v-for="tag in communityPost.topicTags"
          ...
          <p
            class="my-2 2xl:my-4 text-stone-600 2xl:text-lg truncate group-hover:text-stone-100"
          >
          ...
          <div class="mt-4 w-full flex gap-4 justify-between">
            <div class="flex items-baseline gap-2">
              <p
                class="text-sm 2xl:text-base text-stone-700 font-bold group-hover:text-stone-100"
              >
                #{{ usernameList[index] }}
              </p>
              <p
                class="text-sm 2xl:text-base italic text-stone-500 group-hover:text-stone-100"
              >
            ...
            <div class="flex items-center gap-4">
              <span
                class="flex items-center gap-1 text-blue-900 group-hover:text-stone-100"
              >
                <EyeIcon class="w-6 2xl:w-7" />{{ communityPost.views }}
              </span>
              <span
                class="flex items-center gap-1 text-red-600 group-hover:text-stone-100"
              >
                <HeartIcon class="w-6 2xl:w-7" />{{ communityPost.likes }}
              </span>
              <span
                class="flex items-center gap-1 text-stone-700 group-hover:text-stone-100"
              >
