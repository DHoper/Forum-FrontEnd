            ...
            <div class="relative h-full basis-2/5 bg-stone-800 bg-opacity-40 flex flex-col justify-center items-center">
                <router-link :to="{ name: 'Help' }">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="absolute top-6 right-6 w-10 h-10 text-white 2xl:w-12 2xl:h-12">
                ...
                <div class="text-white flex flex-col justify-center items-center gap-6">
                    <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800"
                        ...
                        <div class="border-b-2 border-stone-300 flex items-center gap-2 w-full py-1 2xl:px-2">
                            ...
                            <input class="focus:ring-0 focus:outline-none bg-transparent max-w-52 text-sm 2xl:text-base " type="text"
                    ...
                    <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800"
                        ...
                        <div class="border-b-2 border-stone-300 flex gap-2 py-1 2xl:px-2">
                            ...
                            max-w-52 text-sm 2xl:text-base" type="password" v-model="password" name="password" id="password" required
                ...
                <div class="absolute bottom-10 flex justify-end w-full gap-4 pr-4">
                    <button @click="router.push({ name: 'Articles' })"
                        class="text-white py-1 px-4 hover:bg-stone-100 hover:text-stone-600 tracking-widest transition-all duration-500 2xl:text-lg 2xl:px-6">
                        返回主頁
                    </button>
                    <button
                        class="border-2 border-stone-100 text-stone-100 py-1 px-4 hover:bg-stone-100 hover:text-stone-600 tracking-widest transition-all duration-500 2xl:text-lg 2xl:px-6">
                        聯絡我們
                    </button>
                </div>
            </div>
