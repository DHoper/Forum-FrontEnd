...
const loginIsFailed = computed<LoginStatus | undefined>(
  () => userStore.loggingStatus
);
  ...
  <div class="bg-login bg-cover bg-no-repeat bg-center w-screen h-screen">
    <div class="min-w-fit flex justify-between items-center w-screen h-full">
      <div class="basis-3/5 flex flex-col items-center">
        <div
          class="flex items-center border-4 border-white text-[#b4b2b265] p-4 w-fit"
        >
          <img
        ...
        <span class="text-white text-[#8d8c8ca0] text-3xl font-bold"
          >WILDLENS</span
        >
      </div>
      <div
      ...
      >
        ...
        <div class="text-white flex flex-col justify-center items-center gap-6">
          <div
            ...
            :class="
              loginIsFailed === LoginStatus.EmailError
                ? 'border-red-500'
                : 'border-transparent'
            "
          >
            <div
              class="border-b-2 border-stone-300 flex items-center gap-2 w-full py-1 2xl:px-2"
            >
              <label
                class="text-stone-700 opacity-80 2xl:text-lg"
                for="username"
                >信箱:</label
              >
              <input
          ...
          <div
            class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800"
            :class="
              loginIsFailed === LoginStatus.PasswordError
                ? 'border-red-500'
                : 'border-transparent'
            "
          >
