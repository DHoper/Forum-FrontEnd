        ...
        <div class="min-w-fit flex justify-between items-center w-screen h-full">
            <div class="basis-3/5 flex flex-col items-center">
                <div class="flex items-center border-4 border-white text-[#b4b2b265] p-4 w-fit">
                    <img src="/assets/img/deerIcon.png" alt="deerIcon" class="w-16 xl:w-24">
                </div>
            ...
            <div class="relative h-full basis-2/5 bg-stone-800 bg-opacity-40 flex flex-col justify-center items-center">
                <router-link :to="{ name: 'Help' }">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="absolute top-6 right-6 w-10 h-10 text-white xl:w-12 xl:h-12">
                ...
                <div class="text-white flex flex-col justify-center items-center gap-6">
                    <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800"
                        ...
                        <div class="border-b-2 border-stone-300 flex items-center gap-2 w-full py-1 xl:px-2">
                            <label class="text-stone-700 opacity-80 xl:text-lg" for="username">信箱:</label>
                            <input class="focus:ring-0 focus:outline-none bg-transparent max-w-52 text-sm xl:text-base " type="text"
                    ...
                    <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800"
                        ...
                        <div class="border-b-2 border-stone-300 flex gap-2 py-1 xl:px-2">
                            <label class="text-stone-700 opacity-80 xl:text-lg" for="password">密碼:</label>
                            <input class="focus:ring-0 focus:outline-none bg-transparent
                            max-w-52 text-sm xl:text-base" type="password" v-model="password" name="password" id="password" required
                                autocomplete="autocomplete_off">
                        </div>
                    </div>
                    <button @click="login" type="button"
                        class="w-full bg-stone-600 border-2 border-stone-100 text-white px-4 py-2 hover:bg-stone-100 hover:text-stone-800 focus:outline-none tracking-widest transition-all duration-500 xl:text-lg">
                        登錄
                    </button>
                    <button type="button"
                    ...
                    <div class="text-sm xl:text-base underline">
                ...
                <div class="absolute bottom-10 flex justify-end w-full gap-4 pr-4">
                    <button @click="router.push({ name: 'Articles' })"
                        class="text-white py-1 px-4 hover:bg-stone-100 hover:text-stone-600 tracking-widest transition-all duration-500 xl:text-lg xl:px-6">
                        返回主頁
                    </button>
                    <button
                        class="border-2 border-stone-100 text-stone-100 py-1 px-4 hover:bg-stone-100 hover:text-stone-600 tracking-widest transition-all duration-500 xl:text-lg xl:px-6">
                        聯絡我們
                    </button>
                </div>
            </div>
