        ...
        <div class="flex flex-col items-center">
            ...
            <nav ref="nav" class="flex flex-wrap mt-2 justify-end font-semibold text-xl text-[#ffffff9e]">
                <button @mouseover="addTabClass(0)"
                    class="h-10 mx-4 my-2 transition duration-500 text-white border-white border-b-2 scale-110">探索</button>
            ...
            <div class="w-[30rem] h-48 flex flex-col items-center mt-20 relative">
                <transition>
            ...
            <button ref="button" @click="router.push('Articles')"
                ...
                <span>現&nbsp;&nbsp;在&nbsp;&nbsp;開&nbsp;&nbsp;始</span>
                <img src="/assets/img/deerIcon.png" alt="deerIcon"
                    class="absolute w-full h-full top-0 left-0 opacity-0 hover:animate-deerIcon transition-all focus:animate-deerIconActive"
                    tabindex="0">
                <span
                    class="absolute w-1/2 border-b-2 border-white top-1/2 left-0 -translate-x-full transition-width duration-300 ease-in-out opacity-0 hover:animate-line"></span>
                <span
                    class="absolute w-1/2 border-b-2 border-white top-1/2 right-0 translate-x-full transition-width duration-300 ease-in-out opacity-0"></span>
            </button>
        </div>
        <span class="mt-auto ml-1">&copy; 2023 ~ Now. All rights reserved.</span>
    </div>
</template>
