...
<template>
  ...
  >
    <div class="flex flex-col items-center justify-around h-full">
      ...
      <nav
        ref="nav"
        class="flex flex-wrap mt-2 justify-end font-semibold text-xl text-[#ffffff9e]"
      >
        <button
        ...
        <button
          ...
          class="mx-4 my-2 transition duration-500"
        >
          紀錄
        </button>
        <button
      ...
      <div class="w-[30rem] h-48 flex flex-col items-center relative">
        <Transition>
          ...
          >
            <h2 class="text-7xl mb-4 font-Cormorant tracking-tighter">
              探索&nbsp;&nbsp;視界.
            </h2>
