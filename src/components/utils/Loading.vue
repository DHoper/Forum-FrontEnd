    ...
    <div v-if="isLoading"
        ...
        <div class="flex items-center justify-between gap-8">
            <div class="w-3 h-3 2xl:w-6 2xl:h-6">
                <div class="w-2 h-2 2xl:w-4 2xl:h-4 bg-white opacity-0 rounded-full animate-bounce1"></div>
            </div>
            <div class="w-3 h-3 2xl:w-6 2xl:h-6">
                <div class="w-2 h-2 2xl:w-4 2xl:h-4 bg-white opacity-0 rounded-full animate-bounce2"></div>
            </div>
            <div class="w-3 h-3 2xl:w-6 2xl:h-6">
                <div class="w-2 h-2 2xl:w-4 2xl:h-4 bg-white opacity-0 rounded-full animate-bounce3"></div>
            </div>
            <div class="w-3 h-3 2xl:w-6 2xl:h-6">
                <div class="w-2 h-2 2xl:w-4 2xl:h-4 bg-white opacity-0 rounded-full animate-bounce4"></div>
            </div>
        </div>
    </div>
</template>