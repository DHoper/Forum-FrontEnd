...
<template>
    <nav class="sticky font-Cormorant top-0 w-full bg-stone-600 text-white px-6 py-2 2xl:py-4 flex items-center justify-between z-40"
                                ...
                                <div class="w-64 2xl:w-96">
                                    <div
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-sm 2xl:text-lg">{{ userData.email }}</span>
                                        </div>
                                    </div>
                                    <div class="border border-white">
                                        <div v-for="userAction, index in userActions" :key="index"
                                            ...
                                            <div @click="userAction.action" class="flex-auto flex items-center 2xl:gap-8 gap-2 px-6 py-4 2xl:py-6">
